@echo off
echo SNAKE.BAT - A pure native Windows batch implementation of the classic game
echo ------------------------------------------------------------------------------
echo Written by Dave Benham with some debugging help and technique pointers from
echo DosTips users - See http://www.dostips.com/forum/viewtopic.php?f=3&t=4741
